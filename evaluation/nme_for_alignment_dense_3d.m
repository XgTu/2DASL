% This script is used to evluation dense face alignment performance (3d coordinates) using NME metric, 
...
%     view(2)
    ...
    dis1 = grdVertex(1:3,:) - vertex1(1:3,:);
...
%     view(2)
    ...
    dis2 = grdVertex(1:3,:) - vertex2(1:3,:);
